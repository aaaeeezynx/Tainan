...
export default {
   ...
   route(mokutekichi) {  //設定當前位置到目標地的導航路線
      ...
      this.line.push([this.latitude,this.longitude])
      this.line.push([parseFloat(this.mokutekichiString[0]), parseFloat(this.mokutekichiString[1])])
...
<template>
   <div class="outer">
      <div class="left">
         ...
         <button class="positionNow" @click="getUserLocation()">回到目前位置</button>
      </div>
      <div class="right">
         <div class="rightTop">
               ...
               <div v-for="item in serchedData" class="dataArea">
                  ...
                  <div class="dataAreaTwo">
                     ...
                     <div class="dataAreaTwoRight">
                        ...
                        <!-- <button class="btnRoute">導航到此</button> -->
                     </div>
                  </div>
